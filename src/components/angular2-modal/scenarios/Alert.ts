...
function createBindings(config: AlertConfig): ResolvedBinding[] {
...
export interface AlertConfig extends ModalInvokeConfig {
    title: string;
    titleHtml: string;
    content: string;
    contentHtml: string;
...
export class Alert extends ModalInvokeConfigBuilder<AlertConfig> {
